import { Appointment, DoctorScheduleResponse } from "../types/appointment";
...
export const getAppointment = async (userId: string, consultationType: string, page: number, size: number, startTime: string, endTime: string): Promise<Appointment> => {
